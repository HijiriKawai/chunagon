...
import { QuestionAnswerDash } from './index';

export default {
  title: 'Example/molecules/QuestionAnswer',
  component: QuestionAnswerDash,
  argTypes: {},
} as ComponentMeta<typeof QuestionAnswerDash>;

const Template: ComponentStory<typeof QuestionAnswerDash> = (args) => (
  <QuestionAnswerDash {...args} />
);
